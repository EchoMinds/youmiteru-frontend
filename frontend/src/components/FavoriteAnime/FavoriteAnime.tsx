        ...
        <div className="favoriteAnime">
            <nav className="Navigation_Favorite">
                <ul className="Navigation_Favorite">
                    <li className="li_favorite">
                        <a href="#favorite">Любимое</a>
                    </li>
                    <li className="li_favorite">
                        <a href="#watching">Смотрю</a>
                    </li>
                    <li className="li_favorite">
                        <a href="#planned">Запланировано</a>
                    </li>
                    <li className="li_favorite">
                        <a href="#watched">Просмотрено</a>
                    </li>
                    <li className="li_favorite">
                        <a href="#on-hold">Отложено</a>
                    </li>
                    <li className="li_favorite">
                        <a href="#dropped">Брошено</a>
                    </li>
                </ul>
            </nav>
