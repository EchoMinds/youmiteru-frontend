...
function Home() {
    ...
    return (
        <div className="home">
            ...
            <SliderSeasons title="Popular Seasons" sliderData={popular_seasons || []} />
            <SliderSeasons title="Announced Seasons" sliderData={announced_seasons || []} />
            <SliderSeasons title="Released Seasons" sliderData={released_seasons || []} />
            <Footer />
        </div>
    );
}
